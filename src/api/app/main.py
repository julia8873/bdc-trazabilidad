...
from app.auth import verify_token, AuthenticatedUser, verificar_permisos, JWT_SECRET_KEY, JWT_ALGORITHM
...
from app.models import AuditoriaAcceso, RefreshToken, Rubrica
...
def get_course_students(response: Response, request: Request, 
    ...
    students_list = []
    from app.models import Interaccion, DiscrepanciaAuditoria
...
async def get_student_metrics(response: Response, request: Request, 
    ...
    from app.agent import get_mapeo
...
async def get_student_discrepancias(
    ...
    from app.models import DiscrepanciaAuditoria
...
from app.agent import generar_resumen, seguimiento_resumen
...
from app.agent import load_global_rubric
...
async def _trigger_reconciliation_for_student(
    ...
    from app.models import DiscrepanciaAuditoria, AuditoriaEstado
    from app.models import EventoSync
    from datetime import datetime
    ...
    from app.models import Interaccion
...
from app.agent import get_mapeo
from app.schemas import PaginatedInteraccionesMetadatos, InteraccionMetadatos, InteraccionContenidoResponse, ConceptosFrecuenciasResponse
...
from app.models import PiiVault, PiiAccessLog
